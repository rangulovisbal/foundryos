...
export async function upsertBusinessProfile(
  ...
  const values = {
    ...
    positioningStatement: toNullableText(input.positioningStatement),
    channelUrls: normalizeProfileList(input.channelUrls),
    ...
    conversionAction: toNullableText(input.conversionAction),
    pricingModel: toNullableText(input.pricingModel),
    acquisitionMethod: toNullableText(input.acquisitionMethod),
    salesProcess: toNullableText(input.salesProcess),

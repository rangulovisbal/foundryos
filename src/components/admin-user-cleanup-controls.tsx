    ...
    <div className="grid gap-2">
      <div className="rounded-2xl border border-[color:var(--border)] bg-white/80 p-3">
        ...
        <p className="mt-2 text-xs text-muted">
          Delete test accounts only after any test workspace has been cleaned up. This
          does not enable permanent purge for real client data.
        </p>
        ...
        <div className="mt-3 grid gap-3">
          ...
          <label className="flex items-start gap-3 rounded-xl border border-[color:var(--border)] bg-white/75 px-3 py-3 text-xs text-muted">
            ...
            />
            <span>
              I confirm this account is test, smoke, demo, or sandbox data and does not
              belong to a real client.
            </span>
          </label>
